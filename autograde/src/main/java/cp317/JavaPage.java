...
public class JavaPage extends JFrame implements ActionListener {
    JButton button1;
    JButton button2;
    ...
    public static String forFile1 = "", forFile2 = "", forFile3 = "";
    ...
    public JavaPage() {
        ...
        button3 = new JButton("Step 3: output folder");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == button1) {
            ...
            if (response == JFileChooser.APPROVE_OPTION) {
                ...
                forFile1 = file1.getAbsolutePath();
            }
            ...
            if (response == JFileChooser.APPROVE_OPTION) {
                ...
                forFile2 = file2.getAbsolutePath();
            }
            ...
            if (response == JFileChooser.APPROVE_OPTION) {
                ...
                forFile3 = folder.getAbsolutePath();
            }
        } else if (e.getSource() == processButton) {
            // for excel @Variable assignmentName
            assignmentName = getAssignmentName();
            String[] tasks = { "LeapYear.java", "Encipher.java", "Palindrome.java", "Valid.java" };
            double[] weights = { 0, 0, 0, 0 };

            new WeightingsPage(assignmentName, tasks, weights);
